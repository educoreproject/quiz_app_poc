...
export interface SpecMeta {
  ...
  color: string
  /** Canonical spec/home page for the standard — used as a badge alignment target. */
  specUrl: string
...
export const SPECS: SpecMeta[] = [
  ...
  },
  {
    ...
    color: '#06b6d4',
    specUrl: 'https://www.a4l.org/page/SIF',
  ...
  },
  {
    ...
    color: '#9333ea',
    specUrl: 'https://credreg.net/ctdl/terms',
    layers: ['data-model', 'transport'],
    formats: ['JSON-LD', 'RDF'],
  },
  {
  ...
  },
  {
    ...
    publisher: '1EdTech',
    color: '#f59e0b',
    specUrl: 'https://www.1edtech.org/standards/edu-api',
    layers: ['data-model', 'transport', 'api'],
    formats: ['REST', 'JSON'],
  },
  {
  ...
  },
  {
    ...
    publisher: 'A4L / LIF',
    color: '#14b8a6',
    specUrl: 'https://www.a4l.org/page/LIF',
    layers: ['data-model', 'transport', 'api'],
  ...
  },
  {
    ...
    color: '#84cc16',
    specUrl: 'https://www.uschamberfoundation.org/workforce-development/jedx',
    layers: ['data-model', 'transport'],
    formats: ['JSON'],
  },
  {
  ...
  },
  {
    ...
    publisher: 'U.S. NCES',
    color: '#ca8a04',
    specUrl: 'https://nces.ed.gov/ipeds/cipcode/',
    layers: ['data-model'],
    formats: ['CSV'],
  },
  {
  ...
  },
  {
    ...
    color: '#4f46e5',
    specUrl: 'https://www.dublincore.org/specifications/dctap/',
    layers: ['data-model', 'transport'],
    formats: ['CSV'],
  },
  {
